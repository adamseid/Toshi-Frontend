...
export default class Header extends Component {
  ...
  select = (data) => {
    const ws2 = new WebSocket('ss://build-loadb-1AKB2BWGHE33W-25261184.us-east-1.elb.amazonaws.com/ws/toshi-profile/')
    ws2.onopen = () => {
  ...
  const ws = new WebSocket('ws://build-loadb-1AKB2BWGHE33W-25261184.us-east-1.elb.amazonaws.com/ws/toshi-profile/')
  ws.onopen = ()=>{
    ws.send(
      JSON.stringify({
          request: 'select',
