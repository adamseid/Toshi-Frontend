...
const ws2= new WebSocket('ws://build-loadb-1w6r869nnd2xy-378492499.us-east-1.elb.amazonaws.com/ws/toshi-profile/')
export default class Header extends Component {

  select = (data) => {
    const ws2 = new WebSocket('ss://build-loadb-1w6r869nnd2xy-378492499.us-east-1.elb.amazonaws.com/ws/toshi-profile/')
    ws2.onopen = () => {
  ...
  const ws = new WebSocket('ws://build-loadb-1w6r869nnd2xy-378492499.us-east-1.elb.amazonaws.com/ws/toshi-profile/')
  ws.onopen = ()=>{
    ws.send(
      JSON.stringify({
          request: 'select',
